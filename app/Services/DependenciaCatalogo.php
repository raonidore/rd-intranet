    ...
    public static function itens(): array
    {
        return [
            ...
            [
                ...
                'nome' => 'winbind',
                'pacote' => 'winbind',
                'descricao' => 'Resolve identidades do domínio (usuários/grupos AD) para o sistema Linux quando o servidor atua como Controlador de Domínio.',
                'usado_em' => 'Samba > Domínio',
                'obrigatorio' => false,
            ],
            [
                'chave' => 'krb5-user',
                'nome' => 'krb5-user (Kerberos)',
                'pacote' => 'krb5-user',
                'descricao' => 'Autenticação Kerberos exigida pelo Active Directory Domain Controller.',
                'usado_em' => 'Samba > Domínio',
                'obrigatorio' => false,
            ],
            [
                ...
                'nome' => 'chrony (NTP)',
                'pacote' => 'chrony',
                'descricao' => 'Sincronização de horário — Kerberos rejeita autenticação se o relógio divergir muito entre servidor e clientes.',
                'usado_em' => 'Samba > Domínio',
                'obrigatorio' => false,
            ],
            [
