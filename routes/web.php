...
$router->get('/samba/dominio/usuarios/ver', [SambaDominioController::class, 'usuarioVer']);
$router->get('/samba/dominio/usuarios/excluir', [SambaDominioController::class, 'usuarioExcluir']);
$router->get('/samba/dominio/usuarios/desbloquear', [SambaDominioController::class, 'usuarioDesbloquear']);
$router->get('/samba/dominio/usuarios/expiracao', [SambaDominioController::class, 'usuarioExpiracaoForm']);
$router->post('/samba/dominio/usuarios/expiracao', [SambaDominioController::class, 'usuarioExpiracao']);
...
$router->get('/samba/dominio/grupos/membros/remover', [SambaDominioController::class, 'grupoMembroRemover']);
$router->get('/samba/dominio/grupos/excluir', [SambaDominioController::class, 'grupoExcluir']);
$router->get('/samba/dominio/computadores', [SambaDominioController::class, 'computadores']);
$router->get('/samba/dominio/computadores/excluir', [SambaDominioController::class, 'computadorExcluir']);
$router->get('/samba/dominio/politica-senha', [SambaDominioController::class, 'politicaSenhaForm']);
$router->post('/samba/dominio/politica-senha', [SambaDominioController::class, 'politicaSenhaSalvar']);
$router->get('/samba/dominio/ous', [SambaDominioController::class, 'ous']);
$router->get('/samba/dominio/ous/novo', [SambaDominioController::class, 'ouNovoForm']);
$router->post('/samba/dominio/ous/novo', [SambaDominioController::class, 'ouNovo']);
$router->get('/samba/dominio/ous/excluir', [SambaDominioController::class, 'ouExcluir']);
$router->get('/samba/dominio/gpos', [SambaDominioController::class, 'gpos']);
$router->get('/samba/dominio/gpos/novo', [SambaDominioController::class, 'gpoNovoForm']);
$router->post('/samba/dominio/gpos/novo', [SambaDominioController::class, 'gpoNovo']);
$router->get('/samba/dominio/gpos/excluir', [SambaDominioController::class, 'gpoExcluir']);
$router->post('/samba/dominio/gpos/vincular', [SambaDominioController::class, 'gpoVincular']);
$router->get('/samba/dominio/gpos/desvincular', [SambaDominioController::class, 'gpoDesvincular']);
...
$router->get('/administracao/integracoes/omada', [IntegracoesController::class, 'omadaForm']);
...
$router->post('/ativos/seguranca/remover-isolamento', [AtivoController::class, 'removerIsolamento']);
$router->post('/ativos/seguranca/cancelar-isolamento', [AtivoController::class, 'cancelarIsolamento']);
$router->post('/ativos/seguranca/resolver-evento', [AtivoController::class, 'resolverEventoSeguranca']);
...
$router->post('/ativos/detectar-por-ip', [AtivoController::class, 'detectarPorIp']);
...
$router->post('/ativos/unifi/firewall/excluir', [AtivoController::class, 'unifiExcluirFirewall']);
...
$router->get('/ativos/acesso-remoto/instalar-status', [AcessoRemotoController::class, 'instalarStatus']);
